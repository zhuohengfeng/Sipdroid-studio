...
public class InCallScreen extends CallScreen implements View.OnClickListener, SensorEventListener {
	...
	public void onResume() {
			...
			if (Receiver.pstn_state == null || Receiver.pstn_state.equals("IDLE"))
				if (
					...
					mHandler.sendEmptyMessageDelayed(MSG_ANSWER, 1000);
						...
						(PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(org.sipdroid.sipua.ui.Settings.PREF_AUTO_ONDEMAND, org.sipdroid.sipua.ui.Settings.DEFAULT_AUTO_ONDEMAND)
						&&
		...
		// *************************** comment start **************************************
		/**
		 * the following codes use to play sound of daile button
		 * using ToneGenerator
	...
	/**
	 * why don't use a prepare() method to init a loop for thread
	 * TODO
	 */
