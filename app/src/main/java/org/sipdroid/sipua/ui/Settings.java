...
public class Settings extends PreferenceActivity implements OnSharedPreferenceChangeListener, OnClickListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
    	...
    	switch (item.getItemId()) {
            ...
            case MENU_DELETE:
    			...
    			.setItems(profileFiles, new OnClickListener() {
	...
	private OnClickListener profileOnClick = new OnClickListener() {
		public void onClick(DialogInterface dialog, int whichItem) {
	...
	private OnClickListener deleteOkButtonClick = new OnClickListener() {
