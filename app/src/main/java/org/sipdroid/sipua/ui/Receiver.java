		...
		public static void onText(int type,String text,int mInCallResId,long base) {
	        ...
	        if (text != null) {
				...
				if (type == MISSED_CALL_NOTIFICATION) {
					...
					// ************************* modify start *******************************
					/**
					 * Comment below to use Notification.Builder to insteaded of setLatestEventInfo method
					 * cause it's Deprecated
					 * Edited By Eric Chen
					 * 2016-06-13 17:11:30
					 */
//			        	notification.setLatestEventInfo(mContext, (CharSequence)text, (CharSequence)mContext.getString(R.string.app_name),
